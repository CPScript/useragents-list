...
'Atomz/1.0'
'atSpider/1.0'
'Attentio/Nutch-0.9-dev (Attentios beta blog crawler; www.attentio.com; info@attentio.com)'
'AU-MIC/2.0 MMP/2.0'
'AUDIOVOX-SMT5600'
'augurfind'
'augurnfind V-1.x'
...
'BW-C-2.0'
'bwh3_user_agent'
'Cabot/Nutch-0.9 (Amfibis web-crawling robot; http://www.amfibi.com/cabot/; agent@amfibi.com)'
'Cabot/Nutch-1.0-dev (Amfibis web-crawling robot; http://www.amfibi.com/cabot/; agent@amfibi.com)'
'CamelHttpStream/1.0'
